...
STOCK_DATA_FILE = "stock_metadata_usv3.csv"

OUTPUT_LATEST = "stock_data_usv3/rrg_buckets_usv3_latest.csv"
OUTPUT_HISTORY = "stock_data_usv3/rrg_buckets_usv3_history.parquet"
...
def main():
    ...
    print("=== US RRG Engine (Daily + Weekly) ===")
