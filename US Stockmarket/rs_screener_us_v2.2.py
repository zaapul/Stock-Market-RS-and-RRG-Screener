...
# File paths
# ----------------------------------------------------
PRICE_FILE = "stock_data_usv3/wide_prices_usv3.csv"
OUTPUT_SCORES = "stock_data_usv3/rs_scores_usv3_latest.csv"
OUTPUT_HISTORY = "stock_data_usv3/rs_scores_usv3_history.parquet"
...
# ----------------------------------------------------
# Missing-date detector (price_update pattern)
# ----------------------------------------------------
...
def main():
    ...
    print("\n✅ US RS Screener (Daily, price-aligned) completed.")
